...
namespace TeX2img {
    class CUIOutput : IOutputController {
        ...
        public void showExtensionError() {
            Console.WriteLine("出力ファイルの拡張子は eps/png/jpg/pdf のいずれかにしてください。", "ファイル形式エラー");
        }
